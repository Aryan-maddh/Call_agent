...
import { Search, Settings as SettingsIcon, Bell, Home, ChevronRight, DollarSign, Gift, UserPlus, Percent, Rocket, MousePointer2, Share2, Download, ChevronDown, ChevronLeft } from 'lucide-react';
...
const deviceData = [
  { id: '1252', customer: { name: 'Abagael Drogan', email: 'adrogan8@storify.com', avatar: 'https://i.pravatar.cc/150?u=11' }, status: 'Cancelled', value: '$6475.75', earnings: '$605.74' },
  { id: '3524', customer: { name: 'Alexia Speaks', email: 'aspeaksd@omniture.com', avatar: 'https://i.pravatar.cc/150?u=12' }, status: 'Pending', value: '$6234.84', earnings: '$387.02' },
  { id: '2358', customer: { name: 'Boycie Hartmann', email: 'bhartmann2q@addthis.com', avatar: 'https://i.pravatar.cc/150?u=13' }, status: 'Failed', value: '$2221.71', earnings: '$347.19' },
  { id: '2541', customer: { name: 'Bradan Edgworth', email: 'bedgworth1q@typepad.com', avatar: 'https://i.pravatar.cc/150?u=14' }, status: 'Pending', value: '$3721.16', earnings: '$738.56' },
  { id: '1425', customer: { name: 'Bonny Tebbutt', email: 'btebbutt24@clickbank.net', avatar: 'https://i.pravatar.cc/150?u=15' }, status: 'Paid', value: '$7828.40', earnings: '$453.00' },
  { id: '1122', customer: { name: 'Abagael Drogan', email: 'adrogan8@storify.com', avatar: 'https://i.pravatar.cc/150?u=16' }, status: 'Pending', value: '$7148.09', earnings: '$951.78' },
  { id: '8521', customer: { name: 'Bessy Vasechkin', email: 'bvasechkinx@plala.or.jp', avatar: 'https://i.pravatar.cc/150?u=17' }, status: 'Paid', value: '$2155.12', earnings: '$101.49' },
  { id: '7896', customer: { name: 'Bambi Yerby', email: 'byerby1g@sohu.com', avatar: 'https://i.pravatar.cc/150?u=18' }, status: 'Pending', value: '$9375.13', earnings: '$690.75' },
  { id: '1248', customer: { name: 'Carmon Vasiljevic', email: 'cvasiljevic2o@odnoklassniki.ru', avatar: 'https://i.pravatar.cc/150?u=19' }, status: 'Failed', value: '$2996.63', earnings: '$610.27' },
];
    ...
    <div className="flex flex-col bg-[#E6EDEF] min-h-[1555px] w-full max-w-[1920px] mx-auto animate-fade">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-[#E6EDEF]">
        ...
        <div className="flex items-center gap-4">
          <SettingsIcon size={20} className="text-[#00485A] cursor-pointer" />
      ...
      <div className="px-6 py-2">
          ...
          <div className="flex-[1.3] bg-white rounded-lg p-8 shadow-sm">
             ...
             <div className="flex justify-between items-start px-4">
                <div className="flex flex-col items-center gap-4 text-center max-w-[180px]">
                   <Rocket size={40} className="text-[#00485A] drop-shadow-sm" />
                ...
                <div className="h-32 w-[1px] bg-gray-100 mt-4"></div>
                <div className="flex flex-col items-center gap-4 text-center max-w-[180px]">
                   <MousePointer2 size={40} className="text-[#00485A] opacity-50" />
                ...
                <div className="flex flex-col items-center gap-4 text-center max-w-[180px]">
                   <Share2 size={40} className="text-[#00485A]" />
          ...
          <div className="flex-1 bg-white rounded-lg p-8 shadow-sm">
             <div className="mb-8">
                ...
                <div className="flex gap-2">
                   ...
                   <button className="bg-[#00485A] text-white px-8 py-2 rounded font-medium text-[17px]">Submit</button>
                </div>
             </div>
             <div>
                ...
                <div className="flex gap-2 items-center">
                   ...
                   <button className="w-11 h-11 bg-[#183D63] text-white flex items-center justify-center rounded transition-hover hover:opacity-90">
                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                   </button>
                   <button className="w-11 h-11 bg-black text-white flex items-center justify-center rounded transition-hover hover:opacity-90">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden mb-12">
          <div className="p-8 border-b border-gray-100 flex items-center justify-between">
            ...
            <button className="flex items-center gap-2 border border-[#00485A] px-4 py-2 rounded text-[#00485A] font-medium shadow-sm transition-hover hover:bg-[#00485A]/5">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-[#00485A]/80 text-white text-[18px] font-medium">
                  <th className="px-6 py-4 border-r border-white/20 w-12 text-center">
                    <input type="checkbox" className="w-5 h-5 border-2 border-white rounded bg-transparent accent-white cursor-pointer" />
                  </th>
              ...
              <tbody className="divide-y divide-gray-100">
                {deviceData.map((item, idx) => (
                  <tr key={idx} className="text-[18px] text-[#3D3D3D] hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-6 text-center">
                      <input type="checkbox" className="w-5 h-5 border-gray-300 rounded cursor-pointer" />
                    </td>
          ...
          <div className="p-8 border-t border-gray-100 flex items-center justify-between text-[17px] text-[#A4A4A4]">
             ...
             <div className="flex items-center gap-8">
                ...
                <div className="flex items-center gap-4">
                   ...
                   <ChevronRight size={20} className="text-[#00485A] cursor-pointer hover:opacity-70" />
                </div>
             </div>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="mt-auto py-6 border-t border-gray-200 flex items-center justify-between text-[18px] text-[#3D3D3D]">
